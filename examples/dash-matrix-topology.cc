...
extern vector<vector<bool> > readNxNMatrix (std::string adj_mat_file_name);
...
extern void printMatrix (const char* description, vector<vector<bool> > array);
...
int main(int argc, char *argv[]) {
    ...
    std::string adj_mat_file_name ("src/dash/examples/adjacency_matrix.txt");
    ...
    for (uint32_t user = 0; user < users; user++) {
        ...
        DashClientHelper client("ns3::TcpSocketFactory",
            ...
            InetSocketAddress(ipv4_interfaces[1], port),
